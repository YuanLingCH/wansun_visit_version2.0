...
public class CaseAddressAdapter extends BaseAdapter {
    Context mconext;
    List<caseAddressBean> data;
    LayoutInflater inflater;

    public CaseAddressAdapter(Context mconext, List <caseAddressBean>data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        caseAddressBean urgeRecord  = data.get(position);
        holder= (ViewHolder) convertView.getTag();
        holder.tv_case_rege_promise_amount.setText("姓名："+urgeRecord.getName());
      //  long promiseDate = urgeRecord.getCreateDate()/1000;
       // String promiseTime= unixTime.stampToTime(promiseDate );
        holder.tv_case_rege_promise_date.setText("关系："+ urgeRecord.getRelationText());
        ...
        if (promisePaymentDate==0){
            ...
            holder.tv_case_rege_operate_object_content.setText("添加人："+ urgeRecord.getCreator());
    ...
    class  ViewHolder {
        ...
        TextView tv_case_rege_check_time,tv_case_check_people,tv_case_rege_apply_data,tv_case_apply_people,tv_case_return_money_state,tv_case_return_remark;
