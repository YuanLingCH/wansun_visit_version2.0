...
public class Constants {
    ...
    public static final String APP_ID = "HtzQqaLy5oA4fVrAqAAXp5ZahLQyS1UC4Hc5Hy936boS";
    public static final String SDK_KEY = "3sLRouu3mWtyrJbwrjuqJ7gaFc6QfA8qyHLUYpz6CWKc";
